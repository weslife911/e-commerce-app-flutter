        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: textField(
                  "Enter Email", emailController, "johndoe@gmail.com", false),
            ),
            Padding(
              padding: const EdgeInsets.all(12),
              child: textField(
                  "Enter Mobile", phoneController, "+237XXXXXXXXX", false),
            ),
            Padding(
              padding: const EdgeInsets.all(12),
              child: textField(
            ...
            Padding(
              ...
              child: textField(
                  ...
                  onPressed: () => toggleObscureConfirmPwd(),
                  "..............",
                  field: "pwd",
                  !obscureTextConfrimPwd),
            ),
            Padding(
                padding: const EdgeInsets.all(12),
                child: button(Colors.blue, Colors.white, () {
                  pwdController.text == confirmPwdController.text ? FirebaseAuth.instance.createUserWithEmailAndPassword(
